...
var cjs = require('yamux-js/cjs');
var msgpack = require('@msgpack/msgpack');
var pino = require('pino');
var pretty = require('pino-pretty');
var caller = require('pino-caller');

function _interopDefault (e) { return e && e.__esModule ? e : { default: e }; }

var pino__default = /*#__PURE__*/_interopDefault(pino);
var pretty__default = /*#__PURE__*/_interopDefault(pretty);
var caller__default = /*#__PURE__*/_interopDefault(caller);
...
var createLogger = ({ module }) => {
  ...
  const stream = isDevelopment || isVitest ? pretty__default.default({
    colorize: true
  }) : void 0;
  const parameters = {
    level,
  ...
  return isDevelopment || isVitest ? caller__default.default(pino__default.default(parameters, stream)) : pino__default.default(parameters, stream);
};
...
function createProxyableServer(handler) {
  return new cjs.Server((stream) => {
    stream.on("data", async (data) => {
      ...
      if (error) {
        log2.error(error);
        return stream.write(msgpack.encode(createThrowInstruction(error)));
      }
