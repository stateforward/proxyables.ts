...
declare class IPC {
    ...
    server: boolean;
    //protected methods
    get connectTo(): typeof connect;
    get connectToNet(): typeof connectNet;
    get disconnect(): typeof disconnect;
    get serve(): typeof serve;
    get serveNet(): typeof serveNet;
    protected get log(): typeof log;
}
declare function log(...args: any[]): void;
declare function disconnect(id: any): void;
declare function serve(path: any, callback: any): void;
declare function serveNet(host: any, port: any, UDPType: any, callback: any): void;
declare function connect(id: any, path: any, callback: any): void;
declare function connectNet(id: any, host: any, port: any, callback: any): void;
declare class IPCModule extends IPC {
    constructor();
    IPC: typeof IPC;
}
declare const singleton: IPCModule;
